"""
AnnBayBVAE_graph.py:
Tensorflow Graph for the Annealed Bayesian Beta-Variational Autoencoder
"""
...
'''
This is the Main Annealed Bayesian BVAEGraph.
'''
class AnnBayBVAEGraph(BaseGraph):
    ...
    def create_loss_optimizer(self):
        ...
        with tf.variable_scope('bayae_loss', reuse=self.config.reuse):
            ...
            self.annbaybvae_loss = self.baybvae_loss = tf.add(tf.cast(self.config.num_batches, 'float32') * self.bvae_loss, self.bay_div,
